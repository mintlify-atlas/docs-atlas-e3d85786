---
title: "Eco-It Interactive Recycling Map for Colombian Cities"
sidebarTitle: "Recycling Map"
description: "Eco-It's Leaflet recycling map shows active Colombian collection points filterable by type, with live Socket.io updates and optional route planning."
---
...
<CardGroup cols={3}>
  <Card title="recycling" icon="recycle" href="/admin/map-management">
    A standard recycling drop-off point. Renders with a **green** pin on the map.
  </Card>
  <Card title="ecobottle" icon="bottle-water" href="/admin/map-management">
    An eco-bottle deposit station. Renders with a **lime** pin.
  </Card>
  <Card title="truck" icon="truck" href="/admin/map-management">
    A scheduled collection truck stop. Renders with a **teal** pin.
  </Card>
  <Card title="container" icon="trash" href="/admin/map-management">
    A large waste container. Renders with an **emerald** pin.
  </Card>
  <Card title="green_zone" icon="leaf" href="/admin/map-management">
...
<CardGroup cols={2}>
  <Card title="GET /api/admin/map/points" icon="list" href="/admin/map-management">
    Returns **all** points regardless of `activo` or `visibleToUser` status. Used by the admin map management panel.
  </Card>
  <Card title="POST /api/admin/map/points" icon="plus" href="/admin/map-management">
  ...
  <Card title="PUT /api/admin/map/points/:id" icon="pen" href="/admin/map-management">
    Updates an existing point. If the `imagen` field is a new `data:image/...` base64 string, it is re-uploaded to Cloudinary.
  </Card>
  <Card title="DELETE /api/admin/map/points/:id" icon="trash" href="/admin/map-management">
    Permanently deletes a point from the database.
  </Card>
  <Card title="PATCH /api/admin/map/points/:id/toggle" icon="toggle-on" href="/admin/map-management">
