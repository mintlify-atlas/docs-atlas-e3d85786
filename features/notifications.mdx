---
title: "Real-Time Notifications and Presence Tracking with Socket.io"
sidebarTitle: "Notifications"
description: "Eco-It uses Socket.io for real-time admin moderation alerts, user ban events, and live online presence counters shared across all connected clients."
---
...
<CardGroup cols={2}>
  <Card title="usuario:estado" icon="circle-user" href="/features/notifications">
    Broadcast whenever a user comes online or goes fully offline. Payload: `{ userId: string, isOnline: boolean }`.
  </Card>
  <Card title="usuarios:online" icon="users" href="/features/notifications">
...
<CardGroup cols={2}>
  <Card title="admin:alerta_lenguaje" icon="triangle-exclamation" href="/features/notifications">
  ...
  <Card title="admin:alerta_obscena" icon="ban" href="/features/notifications">
  ...
  <Card title="admin:usuario_baneado" icon="user-slash" href="/features/notifications">
...
<CardGroup cols={3}>
  <Card title="GET /api/admin/notifications" icon="bell" href="/admin/overview">
    Returns all stored notifications, sorted by date descending.
  </Card>
  <Card title="PATCH /api/admin/notifications/mark-read" icon="check" href="/admin/overview">
    Marks one or more notifications as read by adding the requesting admin's user ID to the `readBy` array.
  </Card>
  <Card title="DELETE /api/admin/notifications/:id" icon="trash" href="/admin/overview">
