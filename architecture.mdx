...
<CardGroup cols={2}>
  <Card title="Cloudinary" icon="image" href="/configuration/environment-variables">
  ...
  <Card title="OpenRouter / Google Gemini" icon="brain" href="/features/ecobot-ai">
  ...
  <Card title="MongoDB Atlas" icon="database" href="/configuration/deployment">
