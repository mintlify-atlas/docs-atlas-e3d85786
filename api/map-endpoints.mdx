---
title: "Recycling Map API Endpoints — /api/map Routes Reference"
sidebarTitle: "Map Endpoints"
description: "Public GET endpoint returning all active, user-visible recycling collection points for the Eco-It interactive Leaflet map. No authentication required."
---
