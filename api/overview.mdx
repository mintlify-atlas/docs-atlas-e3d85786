---
title: "Eco-It REST API Reference Overview"
...
Every Eco-It API response is JSON. Successful responses include a `success: true` field alongside the relevant data payload. Error responses include a descriptive `error` or `message` string. The two base shapes are:
